# megabat Source Refactor Plan

This document is the shared working plan for refactoring megabat toward a simpler core model:
...
Objective:
- Add a true generic archive-RPC execution layer behind the new planning primitive so megabat can call arbitrary contracts, including unusual contracts with fixed bytes arguments.
