# megabat Architecture

This document owns the system design.
...
Internal signal-engine mechanics:

- [INTERNAL_SIGNAL_ENGINE.md](internal-signal-engine.md)

## Overview

megabat has three main responsibilities:
...
Delivery is optional. megabat itself remains webhook-first.
...
2. the API authenticates the caller to one megabat owner ID
...
The Envio time-travel limitation is documented separately in [ISSUE_NO_TIME_TRAVEL.md](no-time-travel.md).
...
- [DSL.md](../product/dsl.md) for user-facing signal structure
- [SOURCES.md](sources.md) for source-family composition and future extension
- [API.md](../reference/api.md) for HTTP routes
- [AUTH.md](../reference/auth.md) for the control-plane auth model
- [TELEGRAM_DELIVERY.md](../integrations/telegram-delivery.md) for delivery-specific contracts
- [DESIGN_DECISIONS.md](design-decisions.md) for why the system looks this way
